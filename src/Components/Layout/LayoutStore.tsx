...
import { Search, MapPin, Phone, Info, Store, ShoppingBag } from 'lucide-react';
...
const listMenu = [
    ...
    { icon: <MapPin size={22} />, name: "Peta", url: '/peta' },
                ...
                {listMenu?.map((ls, i) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <span className={`text-[9px] uppercase tracking-[0.15em] transition-all ${
                                isActive 
