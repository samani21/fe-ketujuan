...
const ContactPage = ({ subdomain }: ContactPageProps) => {
    ...
    return (
        <LayoutStore setInfoStore={setStoreData} subdomain={subdomain}>
                ...
                <div className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-slate-100 relative overflow-hidden">
                    {formSubmitted ? (
                        <div className="py-12 text-center animate-in zoom-in duration-300">
                            <div className="w-16 h-16 bg-[vart(--primary-color)]/5 text-[var(--primary-color)] rounded-full flex items-center justify-center mx-auto mb-4">
                                <Send size={30} />
                            </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div className="space-y-1">
                                ...
                                <div className="relative group">
                                    ...
                                    <input name="name" required type="text" className="w-full bg-slate-50 border-none rounded-2xl py-4 pl-11 pr-4 text-sm font-bold text-slate-700 focus:ring-2 focus:ring-[var(--primary-color)]/10 outline-none transition-all" placeholder="Masukkan nama Anda" />
                                </div>
                            </div>
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="relative group">
                                    ...
                                    <input name="email" required type="email" className="w-full bg-slate-50 border-none rounded-2xl py-4 pl-11 pr-4 text-sm font-bold text-slate-700 focus:ring-2 focus:ring-[var(--primary-color)]/10 outline-none transition-all" placeholder="kamu@email.com" />
                                </div>
                            </div>

                            <div className="space-y-1">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Pesan / Masukan</label>
                                <textarea name="message" required className="w-full bg-slate-50 border-none rounded-2xl py-4 px-4 text-sm font-bold text-slate-700 focus:ring-2 focus:ring-[var(--primary-color)]/10 outline-none min-h-[120px] transition-all" placeholder="Tuliskan pesan Anda di sini..."></textarea>
                            </div>

                            <button disabled={submitting} type="submit" className="w-full bg-[var(--primary-color)] text-white font-black py-4.5 rounded-2xl shadow-xl shadow-blue-100 hover:bg-[var(--primary-color)]/90 active:scale-[0.98] transition-all flex items-center justify-center gap-2 uppercase text-xs tracking-[0.2em] disabled:bg-slate-300">
