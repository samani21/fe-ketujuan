...
const InfoPage = () => {
    ...
    return (
        <LayoutStore setInfoStore={setInfoClient}>
            {
                infoCleint ?
                    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <div className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-slate-100 text-center relative overflow-hidden">
                            ...
                            <div className="w-20 h-20 bg-[var(--primary-color)]/5 rounded-full flex items-center justify-center mx-auto mb-4 border border-[var(--primary-color)]/10">
                        ...
                        <a href="#" className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl hover:bg-blue-50 transition-colors group">
                            <div className="flex items-center gap-3">
                                <div className="p-2 bg-[var(--primary-color)]/10 text-blue-600 rounded-lg group-hover:bg-white transition-colors">
                                    <Facebook size={20} />
                                </div>
                        ...
                        {/* Jam Operasional Pusat */}
                        {
                            ...
                            <div className="bg-bg-[var(--primary-color)]/5 rounded-[2.5rem] p-6 border border-[var(--primary-color)]/10">
                                <h3 className="font-bold text-[var(--primary-color)] mb-4 flex items-center gap-2">
                                ...
                                <div className="space-y-2">
                                    {
                                        infoCleint?.business_hour?.map((bh, i) => (
                                            <div className="flex justify-between text-xs">
                                                ...
                                                <span className="font-bold text-[var(--primary-color)]">{bh?.open_time} - {bh?.close_time}</span>
                                            </div>
                                        ))
                                    }
                                </div>
